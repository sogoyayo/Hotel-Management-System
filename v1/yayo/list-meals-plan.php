...
if (isset($_REQUEST['apptoken'])) {
	...
	if (CheckToken($mysqli, $apptoken)==true) {
        ...
        if (($hoteltoken=='') or ($dmctoken=='') or ($contractToken=='')) {
            ...
            $sql = "SELECT * FROM contracts WHERE token='$contractToken' and dmctoken='$dmctoken' and hoteltoken='$hoteltoken' and display=1 and meals_start != '' and meals_end != '' ORDER BY id DESC";
