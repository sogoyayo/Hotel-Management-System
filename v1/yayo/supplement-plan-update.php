...
if (updateSupplementPlan($mysqli, $contractName, $contractToken, $hoteltoken, $dmctoken, $status, $child_age_From, $child_age_To, $currency, $businessName, $city, $country, $subscription, $service, $stay_start, $stay_end, $price_child, $price_adult, $sup_type, $id, $price_childto, $price_childfrom, $supp_perc)===true) {
									// code...
									$array = [
					                    'success' => true,
							...
							// code...
							// insert
if (createContractSupplementPlan($mysqli, $contractName, $contractToken, $hoteltoken, $dmctoken, $status, $child_age_From, $child_age_To, $currency, $timestamp, $businessName, $city, $country, $subscription, $service, $stay_start, $stay_end, $price_child, $price_adult, $sup_type, $price_childto, $price_childfrom)==true) {
									// code...
									$array = [
					                    'success' => true,
						...
						$array = [
							'success' => false,
							'message' => "Unknown Supplement plan"
						];
						$return = json_encode($array);
						echo "$return";
						exit();
