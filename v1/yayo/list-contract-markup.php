	...
	if (CheckToken($mysqli, $apptoken)==true) {
        ...
        if (!empty($country)) {
            ...
            if (!empty($hoteltoken)) {
                ...
                if ($country == "All Countries" or $country == "" or $country == "ALL COUNTRIES") {
                    // code...
                    $sql = "SELECT * FROM contracts WHERE hoteltoken='$hoteltoken' and display=1 GROUP BY token ";
                }else{
                    $sql = "SELECT * FROM contracts WHERE country='$country' and hoteltoken='$hoteltoken' and display=1 GROUP BY token ";
                }
