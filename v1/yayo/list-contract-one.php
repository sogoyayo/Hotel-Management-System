...
if (isset($_REQUEST['apptoken'])) {
	...
	if (CheckToken($mysqli, $apptoken)==true) {
		...
		if (!empty($dmctoken)) {
			// code...
$sql = "SELECT * FROM contracts WHERE dmctoken='$dmctoken' and display=1 and hotelname != '' GROUP BY token ORDER BY hotelname, timestamp ASC ";
